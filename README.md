# gdsam-plugin
Godot 4.6+ Plugin for SAM (Software Automatic Mouth)
...
The Godot 4.1 version of this plugin is still available on the [4.1 branch](https://github.com/deadpixelsociety/gdsam-plugin/tree/4.1).
